...
@pytest.mark.parametrize(
    ...
    [   
        ...
        [[{"art_time": "10:00", "finish_time": "11:00"}], 'Missing "start_time" key in "dynamic_exposed_occupancy". Got keys: "[\'art_time\', \'finish_time\']".'],
        [[{"start_time": "10:00", "ish_time": "11:00"}], 'Missing "finish_time" key in "dynamic_exposed_occupancy". Got keys: "[\'start_time\', \'ish_time\']".'],
    ]
)
...
@pytest.mark.parametrize(
    ["exposed_presence", "error"],
    [
        [[{"start_time": "10", "finish_time": "11:00"}], 'Invalid time format for "start_time" in "dynamic_exposed_occupancy". Expected "HH:MM". Got "10".'],
        [[{"start_time": "10:00", "finish_time": "11"}], 'Invalid time format for "finish_time" in "dynamic_exposed_occupancy". Expected "HH:MM". Got "11".'],
    ]
)
