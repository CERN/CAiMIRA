...
$$
\begin{equation*}
C_{CO_2,n}(t) = f_{CO_2} \cdot \mathrm{BR}_{\mathrm{out},n} \cdot \left( \frac{N_n}{V_r\lambda_{ACH}(t_i)}\cdot (1-\exp(-\lambda_{ACH}(t_i)\cdot(t-t_i)))
+
\left(
