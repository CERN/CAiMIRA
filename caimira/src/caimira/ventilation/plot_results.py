...
def plot_model_concentration_results(
    ...
    clean_air_delivery, _ = find_air_exch.clean_air_per_sec_per_pers(air_exch_list, vent_transition_times, exposure_model)
    ...
    if plot_clean_air_delivery:
        axcad = axviral.twinx()
        extended_air_exch_list = find_air_exch.carry_forward_air_change_times(air_exch_list, vent_transition_times, times)
        clean_air_delivery, _ = find_air_exch.clean_air_per_sec_per_pers(extended_air_exch_list, times, exposure_model)
