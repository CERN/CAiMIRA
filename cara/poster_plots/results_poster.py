...
compare_concentration_curves(models = [
                                      ...
                                      classroom_model_lunch_vent(mask='No mask', lunch_break=True, ventilation=False, hepa=False),
                           ...
                           labels = ['no measures', 'break', 'mask and break',
                                      'Type I Masks, ventilation, break', 'Type I Masks and ventilation, break, hepa'],
                           colors = ['salmon', (0, 0, 0.54, 1), 'royalblue', (0, 0, 0.54, 0.6), (0, 0., 0.54, 0.4)])